...
PV_area=89.4;           % [m2] (power plant area)
BattCapacity=1*20;      % [kWh], Battery capacity
HsysCapacity=1*8000;   % [kWh], Hydrogen tank capacity
HsysInpPowerMax=10;     % [kW], max charge power (electrolyser power)
HsysInpPowerMin= HsysInpPowerMax*0.1; % kW min charge power (electrolyser power)
HsysOutPowerMax=10;     % [kW], max discsharge power (fuel cell power)
...
filename = 'SunPower.csv';
dlmwrite(filename, SunPower, 'delimiter', ',', 'precision', '%.6f');
